...
export const internationalSchema = z.object({
  passportNumber: z
    .string({
      required_error: 'Número do passaporte é obrigatório',
    })
  ...
  passportValidity: z
    .string({
      required_error: 'Data de validade do passaporte é obrigatória',
    })
    .refine((date) => {
  ...
  passportImageUrl: z
    .string({
      required_error: 'Foto do passaporte é obrigatória',
    })
